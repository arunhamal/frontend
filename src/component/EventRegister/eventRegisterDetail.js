  ...
  return (
    <Descriptions title="Registered Event Detail">
      ...
      <Descriptions.Item label={<strong>Profile 1</strong>}>
        <Image
          width={50}
          src={`http://localhost:8000/images/${data?.profile1}`}
        />
      </Descriptions.Item>
      ...
      <Descriptions.Item label={<strong>Profile 2</strong>}>
        <Image
          width={50}
          src={`http://localhost:8000/images/${data?.profile2}`}
        />
      </Descriptions.Item>
      ...
      <Descriptions.Item label={<strong>Profile 3</strong>}>
        <Image
          width={50}
          src={`http://localhost:8000/images/${data?.profile3}`}
        />
      </Descriptions.Item>
      ...
      <Descriptions.Item label={<strong>Profile 4</strong>}>
        <Image
          width={50}
          src={`http://localhost:8000/images/${data?.profile4}`}
        />
      </Descriptions.Item>
      ...
      <Descriptions.Item label={<strong>Profile 5</strong>}>
        <Image
          width={50}
          src={`http://localhost:8000/images/${data?.profile5}`}
        />
      </Descriptions.Item>
      ...
      <Descriptions.Item label={<strong>Profile 6</strong>}>
        {data?.profile6 ? (
          <Image
            width={50}
            src={`http://localhost:8000/images/${data?.profile6}`}
          />
        ) : (
          "-"
        )}
      ...
      <Descriptions.Item label={<strong>Profile 7</strong>}>
        {data?.profile7 ? (
          <Image
            width={50}
            src={`http://localhost:8000/images/${data?.profile7}`}
          />
        ) : (
          "-"
        )}
